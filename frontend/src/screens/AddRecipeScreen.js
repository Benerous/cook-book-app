                ...
                <ul className="container list-unstyled row m-0">
                    ...
                    <li className="col-12 py-2 border-bottom">
                        <div className="row">
                            ...
                            <input className="title col-12 border-0 font-weight-bold" type="text" name="title" id="title" placeholder="Write a title" onChange={e => setTitle(e.target.value)} required/>
                        </div>
                    </li>
                    <li className="col-12 py-2 border-bottom">
                        <div className="row">
